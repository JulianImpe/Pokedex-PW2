...
foreach ($traerListaPokemonsArrays as $pokemon) {
    ...
    <div class='pokemon-card'>
        <div class='pokemon-number'>#{$pokemon["numero_identificador"]}</div>
        <div class='pokemon-name'>{$pokemon["nombre"]}</div>
        <img class='pokemon-image' src='{$pokemon["imagen_ruta"]}' alt='{$pokemon["nombre"]}'>
        <div class='pokemon-type'>
            <img class='type-icon' src='{$pokemon["imagen_ruta_tipo"]}' alt='Type Icon'>
        </div>
        <div class='boton'>
            
            <button class='editar-pokemon'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
