...
foreach ($pokemons as $pokemon) {
    ...
    echo "<button alt='Eliminar' class='eliminar-pokemon' onclick='window.location.href=\"/localhost/Pokedex/Pokedex-PW2/eliminarPokemon.php" . $pokemon["numero_identificador"] . "\"'>
          <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
